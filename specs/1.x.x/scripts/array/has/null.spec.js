...
describe("Array has any null value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNull.hasAnyNull(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNull.hasAnyNull("item"))
...
describe("Array has at least a null value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNull.hasAtLeastNull(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNull.hasAtLeastNull("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has only one null value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNull.hasOnceNull(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNull.hasOnceNull("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has only null values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNull.hasOnlyNull(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNull.hasOnlyNull("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has pair null values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNull.hasPairNull(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNull.hasPairNull("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has exact null values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() =>
      __passArgumentsTest(ArrayNull.hasExactNull(0, numberCount))
    ).toThrowError("The parameter should be an array");
    expect(() =>
      __passArgumentsTest(ArrayNull.hasExactNull("item", numberCount))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
