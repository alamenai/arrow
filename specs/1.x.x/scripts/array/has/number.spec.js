...
function __passArgumentsTest(callback) {
  callback();
}
...
describe("Array has any number value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() => __passArgumentsTest(ArrayNumber.hasAnyNumber(0))).toThrowError(
      "The parameter should be an array"
    );
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasAnyNumber("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the parameter is undefined or null", () => {
    ...
    expect(passUndefinedOrNull).toThrowError(
      "The parameter is null or undefined"
    );
  });
...
describe("Array has at least a null value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasAtLeastNumber(0))
    ).toThrowError("The parameter should be an array");
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasAtLeastNumber("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has only one number value", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasOnceNumber(0))
    ).toThrowError("The parameter should be an array");
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasOnceNumber("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has only number values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasOnlyNumber(0))
    ).toThrowError("The parameter should be an array");
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasOnlyNumber("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has pair number values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasPairNumber(0))
    ).toThrowError("The parameter should be an array");
    expect(() =>
      __passArgumentsTest(ArrayNumber.hasPairNumber("item"))
    ).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
    function pasEmptyArray() {
...
describe("Array has exact number values", () => {
  ...
  it("should throw error if the parameter is not an array", () => {
    ...
    expect(()=> __passArgumentsTest(ArrayNumber.hasExactNumber(0, numberCount))).toThrowError("The parameter should be an array");
    expect(()=> __passArgumentsTest(ArrayNumber.hasExactNumber("item", numberCount))).toThrowError("The parameter should be an array");
  });
  it("should throw error if the array is empty", () => {
  ...
  it("should throw error if the second parameter ( numberCount ) is not a number", () => {
    ...
    expect(passUndefined).toThrowError(
